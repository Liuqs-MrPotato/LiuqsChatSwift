...
class LiuqsPopTransition: NSObject,UIViewControllerAnimatedTransitioning,CAAnimationDelegate {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        pushAnimation.fromValue = startPath.cgPath
        
        pushAnimation.toValue = finalPath.cgPath
